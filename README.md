### 更新与同步 / Updates and Synchronization

> 我已 fork 了原项目，并将其中的所有图片格式转换为 AVIF 格式，以提高图像的加载速度和节省带宽消耗。与原项目保持同步，不接受 PR。请将 PR 提交到 [原仓库](https://github.com/Cute-Dress/Dress)。

I have forked the original project and converted all images to the AVIF format for faster loading and bandwidth savings. This repository remains in sync with the original one, and PRs are not accepted here. Please submit pull requests to the [original repository](https://github.com/Cute-Dress/Dress).
